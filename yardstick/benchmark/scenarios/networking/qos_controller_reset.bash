...
sed -i 's/,neutron.services.qos.qos_plugin.QoSPlugin//' /etc/neutron/neutron.conf
sed -i 's/,qos//' /etc/neutron/plugins/ml2/ml2_conf.ini
sed -i '/extensions/d' /etc/neutron/plugins/ml2/openvswitch_agent.ini
